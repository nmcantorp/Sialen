...
<div class="container portfolio">
  <div class="two_third">
    <div class="flexslider">
      <ul class="slides">
        <li><img src="../images/portfolio/quality_contact_center_1.png" alt="" /></li>
      </ul>
    </div>
  </div>
  ...
  <div class="two_third">
    <div class="flexslider">
      <ul class="slides">
        <li><img src="../images/portfolio/lan_fenix_2.png" alt="" /></li>
        <li><img src="../images/portfolio/lax_fenix_1.png" alt="" /></li>
        <li><img src="../images/portfolio/lax_fenix_3.png" alt="" /></li>
      </ul>
    </div>
  </div>
  <div class="one_third lastcolumn">
  ...
  <div class="two_third">
    <div class="flexslider">
      <ul class="slides">
        <li><img src="../images/portfolio/cc_piedemonte_1.png" alt="" /></li>
        <li><img src="../images/portfolio/cc_piedemonte_2.png" alt="" /></li>
      </ul>
    </div>
  </div>
  <div class="one_third lastcolumn">
  ...
  <div class="two_third">
    <div class="flexslider">
      <ul class="slides">
        <li><img src="../images/portfolio/interpaciolo_1.png" alt="" /></li>
      </ul>
    </div>
  </div>
  <div class="one_third lastcolumn">
