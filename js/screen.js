...
<!-- Responsive Menu -->
			$(document).ready(function(){		
				jQuery("#responsive-menu select").change(function() {
					...
					if (val_selected == 'https://secure28.webhostinghub.com:2096/') {
						window.open('https://secure28.webhostinghub.com:2096/','_blank');
						$(this).val('');
					} else{						
...
<!-- Hook up the FlexSlider -->
			...
			animationDuration: 12000,         //Integer: Set the speed of animations, in milliseconds
